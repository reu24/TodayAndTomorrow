...
public class ElectricFurnaceContainer extends EnergyContainer {

    protected ElectricFurnaceTileEntity tileEntity;
    protected FunctionalIntReferenceHolder currentProcessTime;

    // Server Constructor
    public <T extends Container> ElectricFurnaceContainer(int windowId, PlayerInventory playerInventory, TileEntity tile, RegistryObject<ContainerType<T>> containerType) {
        super(windowId, playerInventory, (ElectricityGuiTileEntity)tile, containerType);
        tileEntity = (ElectricFurnaceTileEntity)tile;
    ...
    // Client Constructor
    public <T extends Container> ElectricFurnaceContainer(int windowId, PlayerInventory playerInventory, PacketBuffer data, RegistryObject<ContainerType<T>> containerType) {
