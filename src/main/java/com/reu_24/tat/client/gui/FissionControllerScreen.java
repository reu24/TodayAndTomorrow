...
public class FissionControllerScreen extends BaseScreen<FissionControllerContainer> {

    private static final ResourceLocation TEXTURE = new ModResourceLocation("textures/gui/coal_generator.png");

    public FissionControllerScreen(FissionControllerContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
